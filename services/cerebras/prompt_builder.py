...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "Ответ пользователю уходит в Telegram с разметкой Markdown (режим бота): выделяй *важное*, _акценты_, ссылки [текст](https://...). Не используй **двойные звёздочки** для жирного — в Telegram нужны одинарные *. "
