...
Верни СТРОГО один JSON-массив (без markdown, без пояснений), каждый элемент:
{
  ...
  "starts_at": "ISO8601 с таймзоной или null если невозможно вывести",
  "venue_name": "название площадки (клуб, театр, зал) или null",
  "street_address": "полный почтовый адрес проведения: город, улица, дом (как в тексте поста, если есть) или null",
